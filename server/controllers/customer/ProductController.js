...
exports.searchProducts = asyncHandler(async (req, res) => {
  try {
    ...
    const products = await Product.find(filters)
      .populate('category', 'name')  // Only get the name of the category
      .populate('subcategory', 'name')  // Only get the name of the subcategory
      .populate('brand', 'name')  // Only get the name of the brand
      .populate('model', 'name')  // Only get the name of the model
      .skip(skip)
      .limit(parseInt(limit))
      .sort(sortOptions);

    const totalCount = await Product.countDocuments(filters); // Total count for pagination
